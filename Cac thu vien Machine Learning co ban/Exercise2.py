...
barwidth = 0.1
y_axis = [50, 100, 200, 10]
index = np.arange(1, 5)
plt.title("Bar chart")
plt.bar(index-barwidth, y_axis, color='g', width=barwidth*2, label="Green")
y_axis = [85, 25, 20, 40]
plt.bar(index+barwidth, y_axis, color='#e2eb34', width=barwidth*2, label="Yellow")
plt.legend()
